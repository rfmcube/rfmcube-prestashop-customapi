...
class Rfmcubeapi extends Module
{
    ...
    {
        Configuration::updateValue('RFMCUBEAPI_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('RFMCUBEAPI_LIVE_MODE');
    ...
    /*public function getContent()
    {
         ...
         *
        if (((bool)Tools::isSubmit('submitRfmcubeapiModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitRfmcubeapiModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'RFMCUBEAPI_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'RFMCUBEAPI_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'RFMCUBEAPI_LIVE_MODE' => Configuration::get('RFMCUBEAPI_LIVE_MODE', true),
            'RFMCUBEAPI_ACCOUNT_EMAIL' => Configuration::get('RFMCUBEAPI_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'RFMCUBEAPI_ACCOUNT_PASSWORD' => Configuration::get('RFMCUBEAPI_ACCOUNT_PASSWORD', null),
        );
    }
